...
作为 Java 程序员，我想大家应该都**背过**面向对象的三大特性：封装，继承，多态。

理论吧，很神奇，虽然就那么几个字，偏偏背完就忘了......

本文着重讨论**多态**，关于理论我就不粘贴了，多态可以大致分为以下几种类型
...
别被名字唬住了，其实就是我们常用的一些语言特性，下面我主要使用 Java 和 Scala 来展示这些不同类型的多态实例
...
**操作符重载**本质上是一个语法糖，实际的体验与函数重载相似，比如 Java 中的 `+` 就是一个可以重载的操作符
...
**参数化多态**于特定多态都是同一年由同一人提出的，最开始由 ML 语言实现（1975年），时至今日，几乎所有的现代化语言都有对应特性进行支持，比如 D 和 C++ 中的模板，C#、Delphi 和 Java 中的泛型。
